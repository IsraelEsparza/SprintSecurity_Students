...
import static com.security.security.security.ApplicationUserPermission.COURSE_WRITE;
...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .csrf().disable() // TODO: I will teach this is detail in the next section
                .authorizeRequests()
                ...
                .antMatchers("/management/api/**").hasAnyRole(ADMIN.name(), ADMINTRAINEE.name())*/ //@PreAuthorize
                .anyRequest()
                .authenticated()
                .and()
                .httpBasic();
